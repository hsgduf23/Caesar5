...
bot = telebot.TeleBot('6830941830:AAHMuhnz0bpEXPllLdZQ_2WQ1ZJmte_TE78')

@bot.message_handler(commands=['start'])
def start(message):
    markup = types.InlineKeyboardMarkup()
    item1 = types.InlineKeyboardButton(text="اضفني لمجموعتك ™", url="http://t.me/moferse_bot?startgroup=new")
